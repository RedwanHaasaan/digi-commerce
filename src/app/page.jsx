...
export default function Home() {
  return (
    <>
      ...
      {/* Features Section */}
      <section className="bg-linear-to-br from-indigo-50 via-purple-50 to-white py-20 lg:py-32">
        <div className="max-w-7xl mx-auto px-4 md:px-8">
          <div className="flex flex-col items-center text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-2xl">
              Experience shopping like never before with our exceptional service
